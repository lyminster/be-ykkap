...
declare module '@fullcalendar/core' {
    ...
    export { EventStore, filterEventStoreDefs, createEmptyEventStore, mergeEventStoreCustomers, getRelevantEvents, eventTupleToStore } from '@fullcalendar/core/structs/event-store';
...
declare module '@fullcalendar/core/structs/event-store' {
    ...
    export function mergeEventStoreCustomers(store0: EventStore, store1: EventStore): EventStore;
